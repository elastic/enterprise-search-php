 ...
 */
class CreateCrawlerEntryPoint extends Request
{
	/**
	 ...
	 */
	public function __construct(string $engineName, string $domainId, EntryPoint $entry_point)
	{
		$this->method = 'POST';
		$engine_name = urlencode($engineName);
		$domain_id = urlencode($domainId);
		$this->path = "/api/as/v0/engines/$engine_name/crawler/domains/$domain_id/entry_points";
