...
class GetDocument extends Request
{
	 ...
	 * @param string $id Unique ID for a content source document. Provided upon or returned at creation.
	 */
	public function __construct(string $contentSourceId, string $id)
	{
		$this->method = 'GET';
