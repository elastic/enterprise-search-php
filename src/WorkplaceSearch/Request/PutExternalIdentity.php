...
use Elastic\EnterpriseSearch\WorkplaceSearch\Schema\ExternalIdentityUpdateDefinition;
...
class PutExternalIdentity extends Request
{
	 ...
	 * @param ExternalIdentityUpdateDefinition $external_identity_update_definition
	 */
	public function __construct(
		...
		$this->body = $external_identity_update_definition;
	}
}
